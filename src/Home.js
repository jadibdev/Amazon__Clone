...
Women, Work, and the Will to Lead'
			...
			<div className='home__row'>
				...
				<Product
					id='123211341'
					title='4W Yoga Mat Eco Friendly TPE Non Slip Yoga Mats by SGS Certified with Carrying Strap,72"x24" Extra '
					price={30.26}
					rating={5}
					image='https://m.media-amazon.com/images/I/71yUCW4B5DL._AC_UL320_.jpg'
				/>
			</div>
